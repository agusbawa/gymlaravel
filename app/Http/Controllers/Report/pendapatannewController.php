...
use PDF;
use Excel;
class pendapatannewController extends Controller
{
    public function member(Request $request)
    {
        ...
        $pendapatans = Transaction::orderBy('transactions.id','asc')
        ...
        ->where('member_histories.extends',null)->whereBetween('member_histories.new_register',[$backdate,$currentdate])
        ->get()
        ;
        
         $paketsatu = Transaction::orderBy('transactions.id','asc')
        ->join('package_prices','transactions.package_price_id','=','package_prices.id')
        ->join('members','members.id','=','transactions.member_id')
        ->join('member_histories','member_histories.member_id','=','members.id')
        ->where('member_histories.extends',null)->whereBetween('member_histories.new_register',[$backdate,$currentdate])
        ...
        ->get()
        ;
        $paketdua = Transaction::orderBy('transactions.id','asc')
        ->join('package_prices','transactions.package_price_id','=','package_prices.id')
        ->join('members','members.id','=','transactions.member_id')
        ->join('member_histories','member_histories.member_id','=','members.id')
        ->where('member_histories.extends',null)->whereBetween('member_histories.new_register',[$backdate,$currentdate])
        ...
        $pakettiga = Transaction::orderBy('transactions.id','asc')
        ->join('package_prices','transactions.package_price_id','=','package_prices.id')
        ->join('members','members.id','=','transactions.member_id')
        ->join('member_histories','member_histories.member_id','=','members.id')
        ->where('member_histories.extends',null)->whereBetween('member_histories.new_register',[$backdate,$currentdate])
        ...
        ->get()
        ;
        $paketpat = Transaction::orderBy('transactions.id','asc')
        ->join('package_prices','transactions.package_price_id','=','package_prices.id')
        ->join('members','members.id','=','transactions.member_id')
        ->join('member_histories','member_histories.member_id','=','members.id')
        ->where('member_histories.extends',null)->whereBetween('member_histories.new_register',[$backdate,$currentdate])
        ...
        return view('dashboard.report.pendapatnew.member',compact('nama_gym','gym','zona','tertentugym','tertentuzona'))
    ...
    public function searchmember(Request $request)
    {
        ...
        ;
            ...
            foreach ($paketpat as $pendapatan => $hah) {
                ...
                return view('dashboard.report.pendapatnew.memberbaru',compact('gyms','nama_gym','gym','zona','tertentugym','tertentuzona'))
                ->with('currentdate',$currentdate)
                ->with('backdate',$backdate)
                ->with('tofiftieen',$tofifteen)
                ->with('pendapatans',$pendapatans)
        ...
        ;
                ...
                foreach ($pakettiga as $pendapatan => $hah) {
                 ...
                 return view('dashboard.report.pendapatnew.carabayar',compact('gyms','nama_gym','gym','zona','tertentugym','tertentuzona'))
                ->with('currentdate',$currentdate)
                ->with('backdate',$backdate)
                ->with('tofiftieen',$tofifteen)
                ->with('pendapatans',$pendapatans)
    ...
    public function link_zonapendapatan(Request $request, $id)
    {
        ...
        # code...
            ...
            return view('dashboard.report.pendapatnew.link_zonapendapatan',compact('gyms','nama_gym','gym','zona','tertentugym','tertentuzona'))
            ->with('currentdate',$currentdate)
            ->with('backdate',$backdate)
            ->with('tofiftieen',$tofifteen)
            ->with('pendapatans',$pendapatans)
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::create('Report Member All', function($excel) use ($total,$satu,$dua,$tiga,$empat){
            $excel->sheet('New sheet', function($sheet) use ($total,$satu,$dua,$tiga,$empat){
                $sheet->loadView('dashboard.report.pendapatnew.member_excel')->with('total',$total)
                                                                            ->with('satu',$satu)
                                                                            ->with('dua',$dua)
                                                                            ->with('tiga',$tiga)
                                                                            ->with('empat',$empat);
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('dashboard.report.pendapatnew.member_excel',compact('total','satu','dua','tiga','empat'));
