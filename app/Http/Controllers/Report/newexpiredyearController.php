...
use PDF;
use Excel;
class newexpiredyearController extends Controller
{
    public function view_newmemberyear(Request $request)
    {
        if($request->get('nama_gym')==0)
        {
            ...
            return view('dashboard.report.new.newexpiredyear.jum_newmemberyear',compact('range','range_1','title_gym','start_date','end_date','start_date_1','end_date_1','nama_gym','tahun_gym','gyms','zonas','tertentugym','tertentuzona'));
        }else{
            $nama_gym = $request->get('nama_gym');
            $tahun_gym = $request->get('tahun_gym');
            $tertentugym = array();
            ...
            return view('dashboard.report.new.newexpiredyear.newmemberyear',compact('range','range_1','title_gym','start_date','end_date','start_date_1','end_date_1','nama_gym','tahun_gym','gyms','zonas','tertentugym','tertentuzona'));
        }
    }
    ...
    public function zona_newmemberyear(Request $request, $id)
    {
        $nama_gym = $request->get('nama_gym');
            ...
            return view('dashboard.report.new.newexpiredyear.zona_newmemberyear',compact('range','range_1','title_gym','start_date','end_date','start_date_1','end_date_1','nama_gym','tahun_gym','gyms','zonas','tertentugym','tertentuzona'));
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::create('Report Member All', function($excel) use ($title_gym,$tahun_gym){
            $excel->sheet('New sheet', function($sheet) use ($title_gym,$tahun_gym){
                $sheet->loadView('dashboard.report.new.newexpiredyear.member_excel')->with('title_gym',$title_gym)
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('dashboard.report.new.newexpiredyear.member_excel',compact('title_gym','tahun_gym'));
    ...
    public function exportExcel1(Request $request)
    {
        ...
        return Excel::create('Report Member All', function($excel) use ($id,$nama_gym,$title_gym,$tahun_gym){
            $excel->sheet('New sheet', function($sheet) use ($id,$nama_gym,$title_gym,$tahun_gym){
                $sheet->loadView('dashboard.report.new.newexpiredyear.search_excel')->with('nama_gym',$nama_gym)
    ...
    public function exportPDF1(Request $request)
    {
        ...
        $pdf = PDF::loadView('dashboard.report.new.newexpiredyear.search_excel',compact('nama_gym','title_gym','tahun_gym','id'));
        $pdf->setPaper('A4', 'landscape');
        return $pdf->download('Report Member All.pdf');
    }
}
