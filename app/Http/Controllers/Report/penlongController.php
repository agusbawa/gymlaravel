...
use PDF;
use Excel;
class penlongController extends Controller
{
    public function member(Request $request)
    {
        ...
        return view('dashboard.report.pendapatan_long.member',compact('nama_gym','gym','zona','tertentugym','tertentuzona'))
    ...
    public function searchmember(Request $request)
    {
        ...
        ;
            ...
            foreach ($paketpat as $pendapatan => $hah) {
                ...
                return view('dashboard.report.pendapatan_long.memberbaru',compact('gyms','nama_gym','gym','zona','tertentugym','tertentuzona'))
                ->with('currentdate',$currentdate)
                ->with('backdate',$backdate)
                ->with('tofiftieen',$tofifteen)
                ->with('pendapatans',$pendapatans)
        ...
        ;
            ...
            ;
                ...
                foreach ($pakettiga as $pendapatan => $hah) {
                 ...
                 return view('dashboard.report.pendapatan_long.carabayar',compact('gyms','nama_gym','gym','zona','tertentugym','tertentuzona'))
                ->with('currentdate',$currentdate)
                ->with('backdate',$backdate)
                ->with('tofiftieen',$tofifteen)
                ->with('pendapatans',$pendapatans)
    ...
    public function link_zonapendapatan(Request $request, $id)
    {
        ...
        # code...
            ...
            return view('dashboard.report.pendapatan_long.link_zonapendapatan',compact('gyms','nama_gym','gym','zona','tertentugym','tertentuzona'))
            ->with('currentdate',$currentdate)
            ->with('backdate',$backdate)
            ->with('tofiftieen',$tofifteen)
            ->with('pendapatans',$pendapatans)
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::create('Report Member All', function($excel) use ($total,$satu,$dua,$tiga,$empat){
            $excel->sheet('New sheet', function($sheet) use ($total,$satu,$dua,$tiga,$empat){
                $sheet->loadView('dashboard.report.pendapatan_long.member_excel')->with('total',$total)
                                                                            ->with('satu',$satu)
                                                                            ->with('dua',$dua)
                                                                            ->with('tiga',$tiga)
                                                                            ->with('empat',$empat);
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('dashboard.report.pendapatan_long.member_excel',compact('total','satu','dua','tiga','empat'));
