                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::where('members.expired_at',$currentdate)
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        {{App\Member::where('members.expired_at',$currentdate)
           ->join('member_histories','member_histories.member_id','=','members.id')
            ->join('gyms','gyms.id','=','members.gym_id')
...
var barData ={
    labels: [@foreach ($zonas as $zona) @endforeach],
    datasets: 
    [
        {
            label: "Report",
