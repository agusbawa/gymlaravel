...
<div class="row">
            ...
            <div class="col-md-12 text-left">
                <form action="/u/report/searchusialongdetail" class="form-inline" method="POST">
                {{ method_field('PATCH') }}
                    {{ csrf_field() }}
                    ...
                    <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelusiamemberlongdetail"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                    <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFusiamemberlongdetail"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen1{{$gym->id}}" style="visibility: hidden;">0%</span><br>Member Perpanjangan</p>
                                    </div>
