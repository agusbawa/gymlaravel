...
$totalmembers = 0;
        ...
        $gymme = DB::table('gyms')->where('zona_id',$zona->id)->get();
        foreach($gymme as $gymku){
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne">
          <h4 class="panel-title">
            @if($nama_gym==2) 
                        <a href="/u/report/link_zonapromo/{{$zona->id}}?range={{$date_awal}}++-++{{$date_akhir}}">
                      @else
          ...
          <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalmembers}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen1{{$zona->id}}" style="visibility: hidden;">0%</span><br>Member yang Bergabung</p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalnonpromos}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2{{$zona->id}}" style="visibility: hidden;">0%</span><br>Non Promo</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalpromos}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3{{$zona->id}}" style="visibility: hidden;">0%</span><br>Promo</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
