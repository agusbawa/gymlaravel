          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $ext = DB::table('target_gym')->where('gym_id',$hai->id)->count('new_member_price'); echo $ext; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $ret = DB::table('target_gym')->where('gym_id',$hai->id)->count('returner'); echo $ret; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $new = DB::table('target_gym')->where('gym_id',$hai->id)->count('new_member_price'); echo $new; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $har = DB::table('target_gym')->where('gym_id',$hai->id)->count('new_member_price'); echo $har; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $per = DB::table('target_gym')->where('gym_id',$hai->id)->count('new_member_price'); echo $per; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $tot = DB::table('target_gym')->where('gym_id',$hai->id)->count('new_member_price'); echo $tot; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $kan = DB::table('kantin')->where('gym_id',$hai->id)->count('total'); echo $kan; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $tar = DB::table('target_gym')->where('gym_id',$hai->id)->count('target_omset'); echo $tar; ?></b></h3>
