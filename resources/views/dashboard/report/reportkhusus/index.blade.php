...
@section('page-title', 'Report Khusus')
          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalextend}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen1" style="visibility: hidden;">0%</span><br>Extend Per Month</p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totaljmlreturner}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2" style="visibility: hidden;">0%</span><br>Target Returner</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalnewmember}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3" style="visibility: hidden;">0%</span><br>New Member</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalharian}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen4" style="visibility: hidden;">0%</span><br>Harian</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalpersonal}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen5" style="visibility: hidden;">0%</span><br>Personal Trainer</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$total}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen6" style="visibility: hidden;">0%</span><br>Total</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$totalkantin}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen7" style="visibility: hidden;">0%</span><br>Kantin</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$total_omset}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen8" style="visibility: hidden;">0%</span><br>Target Omset</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
