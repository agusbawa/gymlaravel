          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $ext = DB::table('target_gym')->where('gym_id',$hai->id)->count('extends_per_month'); echo $ext; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $new = DB::table('target_gym')->where('gym_id',$hai->id)->count('new_member'); echo $new; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $har = DB::table('target_gym')->where('gym_id',$hai->id)->count('harian'); echo $har; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $per = DB::table('target_gym')->where('gym_id',$hai->id)->count('personal_trainer_id'); echo $per; ?></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b><?php $tot = DB::table('target_gym')->where('gym_id',$hai->id)->count('total'); echo $tot; ?></b></h3>
