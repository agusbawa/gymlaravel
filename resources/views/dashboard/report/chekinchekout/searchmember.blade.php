      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne">
          <h4 class="panel-title">
            @if($nama_gym==2) 
                        <a href="/u/report/link_zonacheckin/{{$gym->id}}?range={{$date_awal}}++-++{{$date_akhir}}">
                      @else
        ...
        <div id="{{$gym->id}}" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
          ...
          <div class="col-md-6 col-lg-12">
             ...
             <p class="text-muted"><span id="hidden_persen1{{$gym->id}}" style="visibility: hidden;">0%</span></p>
                ...
                ->join('gyms','gyms.id','=','members.gym_id')
                ->where('gyms.id','=',$gym->id)
                ->whereBetween('check_out',[$backdate,$currentdate])
                ->get()->count()
            }}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2{{$gym->id}}" style="visibility: hidden;">0%</span><br>Jam 07.30-10.00</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                ...
                ->get()->count()
                                        ...
                                        <p class="text-muted"><span id="hidden_persen3{{$gym->id}}" style="visibility: hidden;">0%</span><br>Jam 10.00-16.00</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                ...
                ->get()->count()
                                        ...
                                        <p class="text-muted"><span id="hidden_persen4{{$gym->id}}" style="visibility: hidden;">0%</span><br>Jam 16.00-19.00</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                ...
                ->get()->count()
                                        ...
                                        <p class="text-muted"><span id="hidden_persen5{{$gym->id}}" style="visibility: hidden;">0%</span><br>Jam 19.00-21.00</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
...
<script>
 var pieData = [
     @foreach($gyms as $gym)
   {
      value: {{App\Attendance::whereBetween('check_out',[$backdate,$currentdate])
                ->join('members','members.id','=','attendances.member_id')
                ->join('gyms','gyms.id','=','members.gym_id')
                ->where('gyms.id','=',$gym->id)
                ->get()->count()
