          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$all = $gym->members()->where('expired_at','<',$currentdate)->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$eight = $gym->members()->orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2{{$gym->id}}" style="visibility: hidden;"></span><br> > 18 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$twenty = $gym->members()->orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-24))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3{{$gym->id}}" style="visibility: hidden;"></span><br>18 - 24 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thirty = $gym->members()->orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-34))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen4{{$gym->id}}" style="visibility: hidden;"></span><br>25 - 34 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$fourty = $gym->members()->orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-44))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen5{{$gym->id}}" style="visibility: hidden;"></span><br>35 - 44 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$fifty = $gym->members()->orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-54))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen6{{$gym->id}}" style="visibility: hidden;"></span><br>45 - 54 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$sixty = $gym->members()->orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-64))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen7{{$gym->id}}" style="visibility: hidden;"></span><br>55 - 64 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$seventy = $gym->members()->orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen8{{$gym->id}}" style="visibility: hidden;"></span><br>65+</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
...
<script>
 ...
 var pieData = [
     @foreach($gyms as $gym)
   {
      value: {{number_format(($all = $gym->members()->where('type','New')->get()->count()/ App\Member::get()->count())*100,0,'.','')}},
      label: "{{$gym->title}}",
      color: '#811BD6'
   },
   @endforeach
    ...
    [
        {
            ...
            borderWidth: 1,
            data: [ @foreach($gyms as $gym){{ $gym->members()->where('type','New')->get()->count()}}, @endforeach],
        }
    ]
}
