...
<div class="row">
            ...
            <div class="col-md-12 text-left">
                <form action="/u/report/searchusixt" class="form-inline" method="POST">
                {{ method_field('PATCH') }}
                    {{ csrf_field() }}
                        ...
                        <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen1" style="visibility: hidden;">0%</span><br>Member Expired</p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen2" style="visibility: hidden;">{{number_format(($eight/$all)*100,0,'.','')}}%</span><br> > 18 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen3" style="visibility: hidden;">{{number_format(($twenty/$all)*100,0,'.','')}}%</span><br>18 - 24 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thirty = App\Member::orderBy('nick_name','asc')->where('expired_at','<',$currentdate)->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-34))->get()->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen4" style="visibility: hidden;">{{number_format(($thirty/$all)*100,0,'.','')}}%</span><br>25 - 34 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen5" style="visibility: hidden;">{{number_format(($fourty/$all)*100,0,'.','')}}%</span><br>35 - 44 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen6" style="visibility: hidden;">{{number_format(($fifty/$all)*100,0,'.','')}}%</span><br>45 - 54 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen7" style="visibility: hidden;">{{number_format(($sixty/$all)*100,0,'.','')}}%</span><br>55 - 64 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen8" style="visibility: hidden;">{{number_format(($seventy/$all)*100,0,'.','')}}%</span><br>65+</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
...
<script>
  var pieData = [
   {
      value: {{number_format(($eight/$all)*100,0,'.','')}},
      label: '< 18',
      color: '#811BD6'
   },
   {
      value: {{number_format(($twenty/$all)*100,0,'.','')}},
      label: '18 - 24',
      color: '#8C9BD6'
   },
   {
      value: {{number_format(($thirty/$all)*100,0,'.','')}},
      label: '25 - 24',
      color: '#857886'
   },
   {
      value: {{number_format(($fourty/$all)*100,0,'.','')}},
      label: '35 - 44',
      color: '#857886'
   },
    {
      value: {{number_format(($fifty/$all)*100,0,'.','')}},
      label: '45 - 54',
      color: '#857a77'
   },
   {
      value: {{number_format(($sixty/$all)*100,0,'.','')}},
      label: '55 - 64',
      color: '#857ac5'
   },
   {
      value: {{number_format(($seventy/$all)*100,0,'.','')}},
      label: '65+',
      color: '#857ac5'
   },
