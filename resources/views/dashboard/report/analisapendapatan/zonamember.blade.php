...
<?php $gymme = DB::table('gyms')->where('zona_id',$zona->id)->value('id'); ?>
<?php
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne">
          <h4 class="panel-title">
            @if($nama_gym==2) 
                        <a href="/u/report/link_zonaanalisa/{{$zona->id}}?range={{$date_awal}}++-++{{$date_akhir}}">
                      @else
          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::whereBetween('created_at',[$backdate,$currentdate])->where('gym_id',$gymme)->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen1{{$zona->id}}" style="visibility: hidden;">0%</span><br></p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::whereBetween('created_at',[$backdate,$currentdate])->where('gym_id',$gymme)->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2{{$zona->id}}" style="visibility: hidden;">0%</span><br>Konversi</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::whereBetween('created_at',[$backdate,$currentdate])->where('gym_id',$gymme)->where('status','ACTIVE')->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3{{$zona->id}}" style="visibility: hidden;">0%</span><br>Pelanggan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen4{{$zona->id}}" style="visibility: hidden;">0%</span><br>Jumlah Transaksi</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark">0<b></b></h3>
                                        <p class="text-muted"><span id="hidden_persen5{{$zona->id}}" style="visibility: hidden;">0%</span><br>Rata-Rata Penjualan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark">0<b></b></h3>
                                        <p class="text-muted"><span id="hidden_persen6{{$zona->id}}" style="visibility: hidden;">0%</span><br>Omzet</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
