          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::whereBetween('created_at',[$backdate,$currentdate])->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen1" style="visibility: hidden;">0%</span><br></p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::whereBetween('created_at',[$backdate,$currentdate])->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2" style="visibility: hidden;">0%</span><br>Konversi</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::whereBetween('created_at',[$backdate,$currentdate])->where('status','ACTIVE')->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3" style="visibility: hidden;">0%</span><br>Pelanggan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen4" style="visibility: hidden;">0%</span><br>Jumlah Transaksi</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark">0<b></b></h3>
                                        <p class="text-muted"><span id="hidden_persen5" style="visibility: hidden;">0%</span><br>Rata-Rata Penjualan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark">0<b></b></h3>
                                        <p class="text-muted"><span id="hidden_persen6" style="visibility: hidden;">0%</span><br>Omzet</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
