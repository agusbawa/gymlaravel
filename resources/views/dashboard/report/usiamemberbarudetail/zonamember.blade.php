...
<div class="panel panel-default">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne">
          <h4 class="panel-title">
            @if($nama_gym==2) 
                        <a href="/u/report/link_zonausiabarudetail/{{$zona->id}}?range={{$date_awal}}++-++{{$date_akhir}}">
                      @else
          ...
          <div class="panel-body">
                        <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-center">
                                        <h3 class="text-dark"><b>{{$zonasem = $zona
            ->join('gyms','gyms.zona_id','=','zonas.id')
            ->join('members','members.gym_id','=','gyms.id')
            ->where('members.type','=','New')
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span class="persen" style="visibility: hidden;">@if($zonasem && $all){{number_format(($zonasem/$all)*100,0,'.','')}}@else 0 @endif%</span><br>{{$zona->title}}</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$zonaeight = $zona
            ->join('gyms','gyms.zona_id','=','zonas.id')
            ->join('members','members.gym_id','=','gyms.id')
            ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span class="persen" style="visibility: hidden;">@if($zonaeight && $eight){{number_format(($eightsatu/$eight)*100,0,'.','')}}@else 0 @endif%</span><br> < 18 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
           ...
           ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))
            ...
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3{{$zona->id}}" style="visibility: hidden;">0%</span><br>18 - 24 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
           ...
           ->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-24))
            ...
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen4{{$zona->id}}" style="visibility: hidden;">0%</span><br>25 - 34 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
            ...
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen5{{$zona->id}}" style="visibility: hidden;">0%</span><br>35 - 44 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
           ...
           ->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-44))
            ...
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen6{{$zona->id}}" style="visibility: hidden;">0%</span><br>45 - 54 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
            ...
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen7{{$zona->id}}" style="visibility: hidden;">0%</span><br>55 - 64 Tahun</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
           ...
           ->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-64))
            ...
            ->where('zonas.id',$zona->id)
            ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen8{{$zona->id}}" style="visibility: hidden;">0%</span><br>65+</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
