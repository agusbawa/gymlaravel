                        ...
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="col-md-6 col-lg-12">
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('type','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','30')
                                        ->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-24))
                                        ->get()->count()}}</b></h3>
                                        <p class="text-muted">1 Bulan</p>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$eight = App\Member::orderBy('nick_name','asc')->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-34))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','30')
                                        ->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-34))
                                        ->get()->count()}}</b></h3>
                                        <p class="text-muted">1 Bulan</p>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','30')
                                        ->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-44))
                                        ->get()->count()}}</b></h3>
                                        <p class="text-muted">1 Bulan</p>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','30')
                                        ->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-54))
                                        ->get()->count()}}</b></h3>
                                        <p class="text-muted">1 Bulan</p>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','30')
                                        ->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-64))
                                        ->get()->count()}}</b></h3>
                                        <p class="text-muted">1 Bulan</p>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','30')
                                        ->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))
                                        ->get()->count()}}</b></h3>
                                        <p class="text-muted">1 Bulan</p>
          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-center">
                                        <h3 class="text-dark"><b>{{$all=$gym->members()->where('type','New')->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$eight = App\Member::orderBy('nick_name','asc')
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','30')
                                        ->where('type','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->get()->count()}}</b></h3>
                                        <p class="text-muted">1 Bulan</p>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thrity = $gym->members()->orderBy('nick_name','asc')->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-34))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thrity = $gym->members()->orderBy('nick_name','asc')->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-44))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thrity = $gym->members()->orderBy('nick_name','asc')->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-54))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thrity = $gym->members()->orderBy('nick_name','asc')->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-64))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{ App\Member::orderBy('nick_name','asc')
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                        ->where('package_prices.day','180')
                                        ->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-64))
                                        ->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thrity = $gym->members()->orderBy('nick_name','asc')->where('type','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))}}</b></h3>
