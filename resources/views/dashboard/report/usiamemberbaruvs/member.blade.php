                        ...
                        <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-dark">Member Baru</p>    
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$eight=App\Member::where('type','New')
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$oleight=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$ofeight=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))
                            ...
                            <div class="clearfix"></div>
                             ...
                             <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$twenty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-24))
                                       ->get()->count()}}</b></h3>
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$oltwenty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-24))
                                        ->where('registerfrom','1')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$oftwenty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-24))
                                        ->where('registerfrom','0')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$thirty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))
                                       ->get()->count()}}</b></h3>
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$olthirty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))
                                        ->where('registerfrom','1')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$ofthirty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))
                                        ->where('registerfrom','0')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                            ...
                            <div class="clearfix"></div>
                             ...
                             <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$fourty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-44))
                                       ->get()->count()}}</b></h3>
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$olfourty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))
                                        ->where('registerfrom','1')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$offourty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))
                                        ->where('registerfrom','0')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                            ...
                            <div class="clearfix"></div>
                             ...
                             <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$fifty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-54))
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$olfifty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-54))
                                        ->where('registerfrom','1')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$offifty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-54))
                                        ->where('registerfrom','0')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$sixty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-64))
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$olsixty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-64))
                                        ->where('registerfrom','1')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$ofsixty=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-64))
                                        ->where('registerfrom','0')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$seventy=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$olseventy=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))
                                       ->where('registerfrom','1')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$ofseventy=App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))
                                       ->where('registerfrom','0')
                                       ->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
    ...
    [
        {
            ...
            borderWidth: 1,
            data: [{{App\Member::where('type','New')
                                        ->where('members.type','=','New')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))
                                       ->get()->count()}}],
        }
    ]
