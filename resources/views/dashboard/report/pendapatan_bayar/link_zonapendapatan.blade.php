...
@section('page-title', 'Pendapatan Member By Cara Bayar')
...
<div class="row">
            ...
            <div class="col-md-12 text-left">
                <form action="/u/report/searchpendapatanbayar" class="form-inline" method="POST">
                {{ method_field('PATCH') }}
                    {{ csrf_field() }}
                    ...
                    <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelpendapatanbayar"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                    <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFpendapatanbayar"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne">
         ...
         <?php 
                 $paketsatu1 = App\Transaction::where('gym_id',$gymku->id)->where('payment_method','Cash')
                                ->get()
                                ;
                                $paketdua1 = App\Transaction::where('gym_id',$gymku->id)->where('payment_method','EDC')
                                ->get()
                                ;
                                $pakettiga1 = App\Transaction::where('gym_id',$gymku->id)->where('payment_method','Transfer')
                                ->get()
                                ;
                                    $total1 = 0;
                                    $satu1 = 0;
                                    ...
                                    foreach ($paketsatu1 as $hah) {
                                        $satu1 = $satu1 + $hah->total;
                                    }
                                    foreach ($paketdua1 as $pendapatan => $hah) {
                                        $dua1 = $dua1 + $hah->total;
                                    }
                                    foreach ($pakettiga1 as $pendapatan => $hah) {
                                        $tiga1 = $tiga1 + $hah->total;
                                    }
                                    
                                $total1 = $satu1 + $dua1 + $tiga1;
              ?>
          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h4 class="text-dark"><b>Rp {{$total1}}</b></h4>
                                        <p class="text-muted"><span id="hidden_persen1{{$gymku->id}}" style="visibility: hidden;">0%</span><br>Pendapatan</p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h4 class="text-dark"><b>Rp {{$satu1}}</b></h4>
                                        <p class="text-muted"><span id="hidden_persen2{{$gymku->id}}" style="visibility: hidden;">0%</span><br>Cash</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h4 class="text-dark"><b>Rp {{$dua1}}</b></h4>
                                        <p class="text-muted"><span id="hidden_persen3{{$gymku->id}}" style="visibility: hidden;">0%</span><br>Mesin EDC</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h4 class="text-dark"><b>Rp {{$tiga1}}</b></h4>
                                        <p class="text-muted"><span id="hidden_persen4{{$gymku->id}}" style="visibility: hidden;">0%</span><br>Transfer</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
