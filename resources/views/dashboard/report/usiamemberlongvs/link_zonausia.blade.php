...
<div class="row">
            ...
            <div class="col-md-12 text-left">
                ...
                {{ method_field('PATCH') }}
                    ...
                    <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelusiamemberlongvs"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                    <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFusiamemberlongvs"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
