          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-center">
                                        <h3 class="text-dark"><b>{{$gym->members()->where('extended_at','<=',$currentdate)->where('type','extends')->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','1')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','0')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->get()->count()}}</b></h3>
                           ...
                           <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-24))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','1')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-24))->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','0')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-18))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-24))->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','1')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','0')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-25))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-34))->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-44))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','1')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-44))->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','0')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-35))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-44))->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','1')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-54))->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','0')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-45))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-54))->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                           ...
                           <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-64))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','1')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-64))->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','0')->where('date_of_birth','>',Carbon\Carbon::now()->addYear(-55))->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-64))->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))->get()->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','1')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))->get()->count()}}</b></h3>
                                        <p class="text-muted">Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->orderBy('nick_name','asc')->where('type','extends')->where('registerfrom','0')->where('date_of_birth','<',Carbon\Carbon::now()->addYear(-65))->get()->count()}}</b></h3>
                                        <p class="text-muted">CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
