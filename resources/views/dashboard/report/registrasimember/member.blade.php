...
@section('page-title', 'Register Member Baru')
          ...
          <div class="panel-body">
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    <h3 class="text-dark"><b>Jumlah Member</b></h3>
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::where('created_at','>=',$backdate)->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::where('created_at','>=',$backdate)->where('registerfrom','1')->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2" style="visibility: hidden;">0%</span><br>Baru<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{App\Member::where('created_at','>=',$backdate)->where('registerfrom','0')->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3" style="visibility: hidden;">0%</span><br>Baru<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen4" style="visibility: hidden;">0%</span><br>Paket 1 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('package_prices.day','=','30')
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen5" style="visibility: hidden;">0%</span><br>Paket 1 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen6" style="visibility: hidden;">0%</span><br>Paket 3 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('package_prices.day','=','90')
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen7" style="visibility: hidden;">0%</span><br>Paket 3 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen8" style="visibility: hidden;">0%</span><br>Paket 6 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('package_prices.day','=','180')
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen9" style="visibility: hidden;">0%</span><br>Paket 6 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen10" style="visibility: hidden;">0%</span><br>Paket 12 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('package_prices.day','=','365')
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen11" style="visibility: hidden;">0%</span><br>Paket 12 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
