          ...
          <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$gym->members()->where('created_at','>=',$backdate)->count()}}</b></h3>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen2{{$gym->id}}" style="visibility: hidden;">0%</span></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen3{{$gym->id}}" style="visibility: hidden;">0%</span></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen4{{$gym->id}}" style="visibility: hidden;">0%</span></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen5{{$gym->id}}" style="visibility: hidden;">0%</span></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen6{{$gym->id}}" style="visibility: hidden;">0%</span><br>Baru<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen7{{$gym->id}}" style="visibility: hidden;">0%</span><br>Baru<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen8{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 1 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                                ...
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('package_prices.day','=','30')
                                         ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen9{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 1 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen10{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 3 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen11{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 3 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen12{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 6 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen13{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 6 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen14{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 12 Bulan<br>Online</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        ->where('members.gym_id',$gym->id)
                                        ->count()}}</b></h3>
                                        <p class="text-muted"><span id="hidden_persen15{{$gym->id}}" style="visibility: hidden;">0%</span><br>Paket 12 Bulan<br>CS</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
...
<script>
 var pieData = [
      @foreach($gyms as $gym)
   {
      value: {{$gym->members()->where('created_at','>=',$backdate)->count()}},
      label: '{{$gym->title}}',
      color: '#{{rand(111,999)}}',
   },
    @endforeach
