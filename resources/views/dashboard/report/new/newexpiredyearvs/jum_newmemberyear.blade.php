...
<div class="row">
    <div class="col-md-10" style="margin-bottom: 10px;">
        <form action="/u/report/newexpiredyearvs" class="form-inline" method="GET">
            ...
            <div class="" style="margin-top: 10px;">
                ...
                <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelnewexpiredyearvs"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFnewexpiredyearvs"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
            </div>
        </form>
    </div>
</div>
      ...
      <div class="panel-body">
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$new}}<br><span class="text-muted" id="hidden_persen1" style="visibility: hidden;">{{$per_new}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$jan}}<br><span class="text-muted" id="hidden_persen2" style="visibility: hidden;">{{$per_jan}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$feb}}<br><span class="text-muted" id="hidden_persen3" style="visibility: hidden;">{{$per_feb}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$mar}}<br><span class="text-muted" id="hidden_persen4" style="visibility: hidden;">{{$per_mar}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$apr}}<br><span class="text-muted" id="hidden_persen5" style="visibility: hidden;">{{$per_apr}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$mei}}<br><span class="text-muted" id="hidden_persen6" style="visibility: hidden;">{{$per_mei}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$jun}}<br><span class="text-muted" id="hidden_persen7" style="visibility: hidden;">{{$per_jun}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$jul}}<br><span class="text-muted" id="hidden_persen8" style="visibility: hidden;">{{$per_jul}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$agu}}<br><span class="text-muted" id="hidden_persen9" style="visibility: hidden;">{{$per_agu}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$sep}}<br><span class="text-muted" id="hidden_persen10" style="visibility: hidden;">{{$per_sep}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$oct}}<br><span class="text-muted" id="hidden_persen11" style="visibility: hidden;">{{$per_oct}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$nov}}<br><span class="text-muted" id="hidden_persen12" style="visibility: hidden;">{{$per_nov}}%</span></b></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        <h3 class="text-dark"><b>{{$des}}<br><span class="text-muted" id="hidden_persen13" style="visibility: hidden;">{{$per_des}}%</span></b></h3>
  ...
  <script type="text/javascript">
    ...
    checkbox.change(function(event) {
        ...
        if (checkbox.checked) {
            ...
            document.getElementById("hidden_persen9").style.visibility = "visible";
            document.getElementById("hidden_persen10").style.visibility = "visible"; 
            document.getElementById("hidden_persen11").style.visibility = "visible"; 
            document.getElementById("hidden_persen12").style.visibility = "visible"; 
            document.getElementById("hidden_persen13").style.visibility = "visible"; 
        } else {
            ...
            document.getElementById("hidden_persen9").style.visibility = "hidden";
            document.getElementById("hidden_persen10").style.visibility = "hidden"; 
            document.getElementById("hidden_persen11").style.visibility = "hidden"; 
            document.getElementById("hidden_persen12").style.visibility = "hidden";
            document.getElementById("hidden_persen13").style.visibility = "hidden";
        }
    });
</script> 
