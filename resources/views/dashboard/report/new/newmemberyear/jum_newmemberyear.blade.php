...
<div class="row">
    <div class="col-md-10" style="margin-bottom: 10px;">
        <form action="/u/report/newmemberyear" class="form-inline" method="GET">
            ...
            <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelNewMemberyear"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
            <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFNewMemberyear"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
