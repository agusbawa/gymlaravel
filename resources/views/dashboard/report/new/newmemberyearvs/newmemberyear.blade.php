    ...
    <div class="col-md-10" style="margin-bottom: 10px;">
        <form action="/u/report/newmemberyearvs" class="form-inline" method="GET">
            ...
            <div class="" style="margin-top: 10px;">
                ...
                <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelNewMemberyearvs/search?nama_gym={{$nama_gym}}&tahun_gym={{$tahun_gym}}@foreach($tertentugym as $tent)&gyms[]={{$tent}}@endforeach"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFNewMemberyearvs/search?nama_gym={{$nama_gym}}&tahun_gym={{$tahun_gym}}@foreach($tertentugym as $tent)&gyms[]={{$tent}}@endforeach"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
                @elseif($nama_gym==2||$nama_gym==4)
                <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelNewMemberyearvs/search?nama_gym={{$nama_gym}}&tahun_gym={{$tahun_gym}}@foreach($tertentuzona as $tent)&zonasku[]={{$tent}}@endforeach"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFNewMemberyearvs/search?nama_gym={{$nama_gym}}&tahun_gym={{$tahun_gym}}@foreach($tertentuzona as $tent)&zonasku[]={{$tent}}@endforeach"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
                @elseif($nama_gym==5)
                <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelNewMemberyearvs/search?nama_gym={{$nama_gym}}&tahun_gym={{$tahun_gym}}@foreach($tertentuzona as $tent)&gymku[]={{$tent}}@endforeach"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFNewMemberyearvs/search?nama_gym={{$nama_gym}}&tahun_gym={{$tahun_gym}}@foreach($tertentugymku as $tent)&gymku[]={{$tent}}@endforeach"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
                @endif
            </div>
        </form>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        @if($nama_gym==2) 
                        <a href="/u/report/newmemberyearvs/{{$title_gyms}}?tahun_gym={{$tahun_gym}}">
                      @else
