    ...
    <div class="col-md-10" style="margin-bottom: 10px;">
        <form action="/u/report/newmemberyearvs" class="form-inline" method="GET">
            ...
            <div class="" style="margin-top: 10px;">
                ...
                <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelNewMemberyearvs/search?id={{$id}}&tahun_gym={{$tahun_gym}}"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFNewMemberyearvs/search?id={{$id}}&tahun_gym={{$tahun_gym}}"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
            </div>
        </form>
    </div>
</div>
