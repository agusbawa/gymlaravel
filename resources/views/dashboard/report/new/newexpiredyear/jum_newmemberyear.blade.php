...
<div class="row">
    <div class="col-md-10" style="margin-bottom: 10px;">
        <form action="/u/report/newexpiredyear" class="form-inline" method="GET">
            ...
            <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelnewexpiredyear"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
            <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFnewexpiredyear"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
