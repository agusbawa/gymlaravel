              ...
              <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingOne">
                  <h4 class="panel-title">
                    @if($nama_gym==2) 
                        <a href="/u/report/longpacket/{{$title_gyms}}?range={{$date_awal}}++-++{{$date_akhir}}&range_1={{$date_awal_1}}++-++{{$date_akhir_1}}">
                      @else
                    ...
                    <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen1{{$gym_id}}" style="visibility: hidden;">{{$per_extends}}%</span><br>Perpanjang</p>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen2{{$gym_id}}" style="visibility: hidden;">{{$hitung_sama}}%</span><br>Paket Sama</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen3{{$gym_id}}" style="visibility: hidden;">{{$hitung_upgrade}}%</span><br>Upgrade</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen4{{$gym_id}}" style="visibility: hidden;">{{$hitung_downgrade}}%</span><br>Downgrade</p>
                                    </div>
