                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">{{$gab_total}}<br>{{$pilih_kat}}</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">{{$gab_package}}<br>Harian</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">{{$gab_per}}<br>Personal Trainer</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">{{$gab_tot}}<br>Kantin</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
