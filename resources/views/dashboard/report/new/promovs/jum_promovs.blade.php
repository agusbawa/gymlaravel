                          ...
                          <div class="col-md-6 col-lg-3">
                                        <div class="widget-bg-color-icon card-box fadeInDown animated">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted">{{$tot_non}}<br><span id="hidden_persen1" style="visibility: hidden;">{{$pers_non}}%</span><br>Non Promo</p>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">{{$tot_trans}}<br><span id="hidden_persen2" style="visibility: hidden;">{{$pers_jum}}%</span><br>Jumlah</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">{{$tot_new}}<br><span id="hidden_persen3" style="visibility: hidden;">{{$pers_new}}%</span><br>Member Baru</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted">{{$tot_ext}}<br><span id="hidden_persen4" style="visibility: hidden;">{{$pers_ext}}%</span><br>Member Perpanjangan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
