                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingOne">
                      <h4 class="panel-title">
                        @if($nama_gym==2) 
                        <a href="/u/report/extendlongvs/{{$title_gyms}}?range={{$date_awal}}++-++{{$date_akhir}}&range_1={{$date_awal_1}}++-++{{$date_akhir_1}}&pilih_kat={{$pilih_kat}}">
                      @else
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen1{{$gym_id}}" style="visibility: hidden;">{{$per_jum}}%</span></p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen2{{$gym_id}}" style="visibility: hidden;">{{$per_pac1}}%</span><br>Paket 1 Bulan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen3{{$gym_id}}" style="visibility: hidden;">{{$per_pac2}}%</span><br>Paket 3 Bulan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen4{{$gym_id}}" style="visibility: hidden;">{{$per_pac3}}%</span><br>Paket 6 Bulan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen5{{$gym_id}}" style="visibility: hidden;">{{$per_pac4}}%</span><br>Paket 12 Bulan</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
