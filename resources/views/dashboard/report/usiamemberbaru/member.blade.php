...
<div class="panel panel-default table-responsive" style="text-align:center; overflow:auto;" >
                        <table class="table table-bordered" >
                            ...
                            <tr>
                                <td>{{$all=App\Member::join('member_histories','member_histories.member_id','members.id')
                                ->whereBetween('new_register',[$backdate,$currentdate])->get()->count()}}
                        ...
                        <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box fadeInDown animated">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-muted"><span id="hidden_persen1" style="visibility: hidden;">0%</span><br>Member Baru</p>
                                    </div>
