...
<div class="row">
            ...
            <div class="col-md-12 text-left">
                ...
                {{ method_field('PATCH') }}
                    ...
                    <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelMemberBaru"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                    <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFMemberBaru"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
...
<div class="panel panel-default table-responsive" style="text-align:center; overflow:auto;" >
    ...
    <table class="table table-bordered" >
        ...
        <tr>
        <td>Jumlah {{$all = App\Member::orderBy('members.id','DESC')
                                        ->join('package_prices','package_prices.id','=','members.package_id')
                                      ->join('member_histories','member_histories.member_id','members.id')
                                        ->whereBetween('extends',[$backdate,$currentdate])
                                        ->get()->count()}}</td>
    ...
    [
        {
            ...
            borderWidth: 1,
            data: [
         {{App\Member::orderBy('members.id','DESC')
         ->join('package_prices','package_prices.id','=','members.package_id')
         ->where('package_prices.day','=','30')
