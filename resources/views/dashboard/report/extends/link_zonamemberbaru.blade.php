...
<div class="row">
            ...
            <div class="col-md-12 text-left" style="margin-bottom: 10px;">
                ...
                {{ method_field('PATCH') }}
                    ...
                    <a class="btn btn-sm btn-success waves-effect waves-light" role="button" href="/exportExcelextends/search?id={{$id}}&range={{Carbon\Carbon::parse($backdate)->format('d-m-Y')}} - {{Carbon\Carbon::parse($currentdate)->format('d-m-Y')}}"><i class="glyphicon glyphicon-download-alt"></i> Export Excel</a>
                    <a class="btn btn-sm btn-danger waves-effect waves-light" role="button" href="/exportPDFextends/search?id={{$id}}&range={{Carbon\Carbon::parse($backdate)->format('d-m-Y')}} - {{Carbon\Carbon::parse($currentdate)->format('d-m-Y')}}"><i class="glyphicon glyphicon-download-alt"></i> Export PDF</a>
