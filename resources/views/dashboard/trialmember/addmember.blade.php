...
@section('page-breadcrumb')
    {!!Breadcrumbs::render('trial-addmember',$trial)!!}
@endsection
@section('content')
<form action="/u/trialmember/addmember" method="POST" enctype="multipart/form-data" autocomplate="false">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group label-floating @if($errors->has('date_of_birth')) has-error @endif">
                                ...
                                <input type="text" class="form-control datepicker" placeholder="Tanggal Lahir (tanggal/bulan/tahun)" name="date_of_birth" value="{{old('date_of_birth',date('d-m-Y',strtotime($trial->date_of_birth)))}}">
                    ...
                    <div class="form-group label-floating @if($errors->has('email')) has-error @endif">
                        ...
                        <input type="email" class="form-control" name="email" value="{{old('email',$trial->email)}}">
