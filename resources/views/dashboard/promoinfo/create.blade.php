...
@section('title', 'Tambah Promo Info')
@section('page-title', 'Tambah Promo Info')
@section('page-breadcrumb')
    {!!Breadcrumbs::render('promoinfo-create')!!}
@endsection
@section('content')
    <div class="row">
        <div class="col-lg-6">
            <form action="/u/promoinfo" method="POST">
                <div class="card-box">
                    {{ method_field('POST') }}
                    {{ csrf_field() }}
                    ...
                    <div class="form-group label-floating @if($errors->has('tgl_promo')) has-error @endif">
                        ...
                        <input type="text" class="form-control input-daterange-datepicker" placeholder="Tanggal Promo" name="tgl_promo" value="{{old('tgl_event')}}">
